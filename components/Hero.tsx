        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              <button
                onClick={onBookNow}
                className="w-full sm:w-auto bg-[#0f382c] hover:bg-emerald-900 text-amber-300 font-black text-lg px-9 py-4.5 rounded-2xl shadow-xl transform hover:-translate-y-1 active:scale-98 transition duration-200 flex items-center justify-center gap-3 uppercase tracking-wider"
              >
